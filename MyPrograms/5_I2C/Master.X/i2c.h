...
void start_event_i2c(void){
    ...
    while (I2C1CONLbits.SEN); // Hardware automatically clears Start Bit
}
...
void rep_start_event_i2c(void){
    ...
    while (I2C1CONLbits.RSEN); // Hardware automatically clears it
...
void stop_event_i2c(void){
    ...
    //while (I2C1CONLbits.PEN); // Hardware automatically clears it
...
void ack_event_i2c(void){
    ...
    //while (I2C1CONLbits.ACKEN); // Hardware automatically clears it --> not needed because each function calls "wait_i2c();" first
...
void nack_event_i2c(void){ //--> before generating stop event
    ...
    I2C1CONLbits.ACKEN = 1;     //Writing ACKEN = 1 initiates a master acknowledge sequence
    //while (I2C1CONLbits.ACKEN); // Hardware automatically clears it
...
void wait_i2c(void){
    while(I2C1CONLbits.SEN || I2C1CONLbits.RSEN || I2C1CONLbits.PEN || I2C1CONLbits.RCEN || I2C1CONLbits.ACKEN || I2C1STATbits.ACKSTAT || I2C1STATbits.TRSTAT);
}
...
unsigned char read_i2c(void){
    ...
    if (I2C1STATbits.I2COV){ I2C1STATbits.I2COV = 0; UART1_Write_Text("I2COV warning. Byte clash receiving I2C");}
    return  I2C1RCV;
}
