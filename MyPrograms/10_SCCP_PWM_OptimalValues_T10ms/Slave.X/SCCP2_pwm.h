...
#define FREFCLK 6250000

float desired_period = 0.01; //I want a 10ms period to control de servos (BETA VERSION - TRYING)
...
void set_REFCLK(){
    ...
    REFOCONHbits.RODIV = 8; //Base clock value divided by 16 (2 * 8)
    while(_ROSWEN){};       
