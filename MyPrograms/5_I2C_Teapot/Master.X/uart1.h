...
void UART1_Write_uint8(int num){
    int i=1;
    int max_number_of_digits = 4; 
    char number_str[4+1] = {'\0'};  //This '+1' is to consider the EOL '\0'
    char *start_of_string;
    ...
    start_of_string = number_str+max_number_of_digits+1-i;
    UART1_Write_Text(start_of_string);
}
