...
volatile uint8_t teapotPacket[15] = { '$', 0x02, 0,0, 0,0, 0,0, 0,0, 0x00, 0x00, '\r', '\n', '\0' };
...
void MPU6050_read_accel_gyro(void){
    ...
    teapotPacket[2] = aux[0];
    teapotPacket[3] = aux[1];
    teapotPacket[4] = aux[4];
    teapotPacket[5] = aux[5];
    teapotPacket[6] = aux[8];
    teapotPacket[7] = aux[9];
    teapotPacket[8] = aux[12];
    teapotPacket[9] = aux[13];
    UART1_Write((char)teapotPacket[0]);
    UART1_Write((char)teapotPacket[1]);
    UART1_Write((char)teapotPacket[2]);
    UART1_Write((char)teapotPacket[3]);
    UART1_Write((char)teapotPacket[4]);
    UART1_Write((char)teapotPacket[5]);
    UART1_Write((char)teapotPacket[6]);
    UART1_Write((char)teapotPacket[7]);
    UART1_Write((char)teapotPacket[8]);
    UART1_Write((char)teapotPacket[9]);
    UART1_Write((char)teapotPacket[10]);
    UART1_Write((char)teapotPacket[11]);
    UART1_Write((char)teapotPacket[12]);
    UART1_Write((char)teapotPacket[13]);
    teapotPacket[11]++;
}
