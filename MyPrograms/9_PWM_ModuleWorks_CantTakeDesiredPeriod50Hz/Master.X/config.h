...
#if 1
#pragma message "Remember to assign ports to slave. MSI configuration is in another place"
#pragma message "Take a look at S1MSRE and S1SSRE"
#endif
...
#pragma config CPRC10 = SEC1            // Pin RC11 Ownership Bits (Secondary core owns pin.)
...
// FS1OSCSEL
#pragma config S1FNOSC = PRIPLL         // Oscillator Source Selection (Primary Oscillator with PLL module (XT + PLL, HS + PLL, EC + PLL))
